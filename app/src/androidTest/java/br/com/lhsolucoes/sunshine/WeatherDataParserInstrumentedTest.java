...
public class WeatherDataParserInstrumentedTest {
    ...
    public void testMountainViewThirdDay() throws JSONException {
        Assert.assertEquals(14.1, WeatherDataParser.getMaxTemperatureForDay(WEATHER_DATA_MTV_JUN_4, 2));
    }

    @Test
    public void testFremontLastDay() throws JSONException {
        Assert.assertEquals(16.75, WeatherDataParser.getMaxTemperatureForDay(WEATHER_DATA_FREMONT_JUN_4, 6));
    }
